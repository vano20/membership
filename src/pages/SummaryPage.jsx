  ...
  const headers = [
    {
      ...
      label: "No",
      style: "max-w-12",
      render: (_, index) => <div className="font-semibold">{index + 1}</div>,
    },
    {
      key: "company_name",
    ...
    },
    {
      key: "qualification",
      label: "Kualifikasi",
      render: (item) => <>{capitalizeWord(item.qualification)}</>,
    },
    {
      key: "province",
      label: "Provinsi",
      render: (item) => <>{capitalizeWord(item.province?.name || "")}</>,
    },
    {
      key: "period",
      label: "Periode",
      ...
      <div className="flex flex-col w-screen min-h-screen items-center overflow-auto bg-white pb-8">
        <div className="flex flex-col w-full h-full bg-slate-200 border-2 rounded-md shadow-lg shadow-slate-300 mx-auto p-8 border-transparent">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-4xl font-semibold">List Rekapitulasi</h2>
